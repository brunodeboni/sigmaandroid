...
<html>
<head>
<title>SIGMA ANDROID: Preços</title>
    <meta charset="utf-8">
...
<body>
    <div id="container">
		<div id="content">
			...
			<div id="chamada">
				<p>
					<a href="cadastro.php">Crie agora mesmo</a> a sua conta e teste gratuitamente por 30 dias.<br>
					Se o seu período de testes expirou, escolha uma das assinaturas abaixo para continuar usando o SIGMA ANDROID.
				</p> 
			</div>
	        ...
	        <div id="precos-wrapper">
	        	<div id="preco-instalacao">
	            	<div id="preco-instalacao-texto">Instalação e configuração SIGMA ANDROID (Taxa única)</div>
	            ...
	            <div id="preco-assinatura">
	            	<div id="preco-assinatura-usuario">
	                    ...
	                    <div class="comprar">
	                    	<a href="userpanel/index.php" class="btn-comprar">Comprar</a>
	                    </div>
	            	</div>
	    	...
	    	<div id="pagamento-wrapper">
	    		...
	    		<div id="processo-compra">
	    			...
	    			<div class="pagamento-texto">Se sua empresa tem um processo de compras que obrigatoriamente envolve envio de proposta, emissão de pedido ou outros procedimentos internos, entre em contato com o Setor Comercial, que irá lhe fornecer o atendimento necessário. <a href="http://redeindustrial.mysuite.com.br/clientlegume.php?param=hd_chat_gc_cad_chatdep&inf=&sl=rdi&lf=&ca=&cr=&redirect=http://redeindustrial.mysuite.com.br/empresas/rdi/central.php" target="_blank">Clique aqui</a> e abra um ticket.</div>
	    		</div>
	    	</div>
